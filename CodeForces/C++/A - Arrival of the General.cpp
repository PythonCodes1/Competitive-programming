...
the general is rather short-sighted and he thinks that the soldiers lined up correctly if the
...
a 1, a 2, ..., a n (1 ≤ a i ≤ 100) the values of the soldiers' heights in the order of
soldiers' heights' increasing in the order from the beginning of the line to its end. 
The numbers are space-separated. Numbers a 1, a 2, ..., a n are not necessarily different.

Output
Print the only integer — the minimum number of seconds the colonel will need to form a line-up the general will like.

http://codeforces.com/problemset/problem/144/A?mobile=true
*/
